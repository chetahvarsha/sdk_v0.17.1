...
use super::{Address, BoxedBytes, DcdtTokenType};

pub struct DcdtTokenData<BigUint: BigUintApi> {
...
impl<BigUint: BigUintApi> DcdtTokenData<BigUint> {
...
impl<BigUint: BigUintApi> NestedEncode for DcdtTokenData<BigUint> {
	#[inline]
...
impl<BigUint: BigUintApi> TopEncode for DcdtTokenData<BigUint> {
	#[inline]
...
#[allow(clippy::redundant_clone)]
impl<BigUint: BigUintApi> NestedDecode for DcdtTokenData<BigUint> {
	fn dep_decode<I: NestedDecodeInput>(input: &mut I) -> Result<Self, DecodeError> {
		let token_type = DcdtTokenType::dep_decode(input)?;
	...
	fn dep_decode_or_exit<I: NestedDecodeInput, ExitCtx: Clone>(
		...
		let token_type = DcdtTokenType::dep_decode_or_exit(input, c.clone(), exit);
...
impl<BigUint: BigUintApi> TopDecode for DcdtTokenData<BigUint> {
...
impl<BigUint: BigUintApi> TypeAbi for DcdtTokenData<BigUint> {
	fn type_name() -> String {
		"DcdtTokenData".into()
	}
}
