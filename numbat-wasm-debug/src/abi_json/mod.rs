...
pub fn contract_abi<AbiObj: numbat_wasm::api::ContractAbiProvider>() -> String {
	let abi = <AbiObj as numbat_wasm::api::ContractAbiProvider>::abi();
	serialize_abi_to_json(&abi)
}

/// Function provided for convenience.
/// Prints the ABI JSON of a contract to console.
pub fn print_abi<AbiTrait: numbat_wasm::api::ContractAbiProvider>() {
