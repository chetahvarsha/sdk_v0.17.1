...
mod module_1 {
	...
	//////// CONTRACT TRAIT /////////////////////////////////////////////////////////////////////////
	/////////////////////////////////////////////////////////////////////////////////////////////////
	pub trait VersionModule: numbat_wasm::api::ContractBase + Sized
	where
	...
	/////////////////////////////////////////////////////////////////////////////////////////////////
	pub trait AutoImpl: numbat_wasm::api::ContractBase {}
	...
	pub trait EndpointWrappers: VersionModule + numbat_wasm::api::ContractPrivateApi
	where
		for<'a, 'b> &'a Self::BigUint: core::ops::Add<&'b Self::BigUint, Output = Self::BigUint>,
		for<'a, 'b> &'a Self::BigUint: core::ops::Sub<&'b Self::BigUint, Output = Self::BigUint>,
		for<'a, 'b> &'a Self::BigUint: core::ops::Mul<&'b Self::BigUint, Output = Self::BigUint>,
	...
	pub trait ProxyTrait: numbat_wasm::api::ProxyObjApi + Sized {
		fn version(
			self,
		) -> ContractCall<Self::SendApi, <Self::BigInt as numbat_wasm::io::EndpointResult>::DecodeAs>
		{
			...
			let mut ___contract_call___ = numbat_wasm::types::new_contract_call(
				...
				___payment___,
				___nonce___,
				numbat_wasm::types::BoxedBytes::from(&b"version"[..]),
			);
			___contract_call___
		}
	}
...
mod sample_adder {
	...
	/////////////////////////////////////////////////////////////////////////////////////////////////
	pub trait Adder:
		super::module_1::VersionModule + numbat_wasm::api::ContractBase + Sized
	where
		...
		for<'b> Self::BigInt: core::ops::RemAssign<&'b Self::BigInt>,
	{
		fn get_sum(&self) -> Self::BigInt {
			...
			numbat_wasm::storage_get(self.get_storage_raw(), &key[..])
		}
		fn set_sum(&self, sum: &Self::BigInt) {
			let key: &'static [u8] = b"sum";
			numbat_wasm::storage_set(self.get_storage_raw(), &key[..], &sum);
		}
		fn callback(&self) {}
		fn callbacks(&self) -> self::CallbackProxyObj<Self::SendApi> {
			<self::CallbackProxyObj::<Self::SendApi> as numbat_wasm::api::CallbackProxyObjApi>::new_cb_proxy_obj(self.send())
		}
	}

	pub trait EndpointWrappers:
		Adder + numbat_wasm::api::ContractPrivateApi + super::module_1::EndpointWrappers
	where
		for<'a, 'b> &'a Self::BigUint: core::ops::Add<&'b Self::BigUint, Output = Self::BigUint>,
		for<'a, 'b> &'a Self::BigUint: core::ops::Sub<&'b Self::BigUint, Output = Self::BigUint>,
		for<'a, 'b> &'a Self::BigUint: core::ops::Mul<&'b Self::BigUint, Output = Self::BigUint>,
		...
		for<'b> Self::BigInt: core::ops::RemAssign<&'b Self::BigInt>,
	{
		...
		fn call_get_sum(&self) {
			self.call_value().check_not_payable();
			numbat_wasm::api::EndpointArgumentApi::check_num_arguments(&self.argument_api(), 0i32);
		...
		fn call_init(&self) {
			self.call_value().check_not_payable();
			numbat_wasm::api::EndpointArgumentApi::check_num_arguments(&self.argument_api(), 1i32);
			let initial_value = numbat_wasm::load_single_arg::<Self::ArgumentApi, Self::BigInt>(
				self.argument_api(),
				0i32,
		...
		fn call_add(&self) {
			self.call_value().check_not_payable();
			numbat_wasm::api::EndpointArgumentApi::check_num_arguments(&self.argument_api(), 1i32);
			let value = numbat_wasm::load_single_arg::<Self::ArgumentApi, Self::BigInt>(
				self.argument_api(),
				0i32,
				ArgId::from(&b"value"[..]),
			);
	...
	pub trait ProxyTrait: numbat_wasm::api::ProxyObjApi + super::module_1::ProxyTrait {
		fn get_sum(
			self,
		) -> numbat_wasm::types::ContractCall<
			Self::SendApi,
			<Self::BigInt as numbat_wasm::io::EndpointResult>::DecodeAs,
		> {
			let (___api___, ___address___, ___token___, ___payment___, ___nonce___) =
				self.into_fields();
			let mut ___contract_call___ = numbat_wasm::types::new_contract_call(
				...
				___payment___,
				___nonce___,
				numbat_wasm::types::BoxedBytes::from(&b"get_sum"[..]),
			);
			___contract_call___
		}
		fn add(
			self,
			amount: &Self::BigInt,
		) -> ContractCall<Self::SendApi, <SCResult<()> as numbat_wasm::io::EndpointResult>::DecodeAs>
		{
			let (___api___, ___address___, ___token___, ___payment___, ___nonce___) =
				self.into_fields();
			let mut ___contract_call___ = numbat_wasm::types::new_contract_call(
				...
				___payment___,
				___nonce___,
				numbat_wasm::types::BoxedBytes::from(&b"add"[..]),
			);
			numbat_wasm::io::serialize_contract_call_arg(
				amount,
	...
	impl numbat_wasm::api::ContractAbiProvider for AbiProvider {
		...
		fn abi() -> numbat_wasm::abi::ContractAbi {
			...
			contract_abi.coalesce(
				<super::module_1::AbiProvider as numbat_wasm::api::ContractAbiProvider>::abi(),
			);
			contract_abi
		}
	}
	...
	impl<SA> super::module_1::ProxyTrait for Proxy<SA> where SA: numbat_wasm::api::SendApi {}

	impl<SA> ProxyTrait for Proxy<SA> where SA: numbat_wasm::api::SendApi {}
	...
	pub trait CallbackProxy: numbat_wasm::api::CallbackProxyObjApi + Sized {
		fn my_callback(self, caller: &Address) -> numbat_wasm::types::CallbackCall {
			let ___api___ = self.into_api();
			let mut ___closure_arg_buffer___ = numbat_wasm::types::ArgBuffer::new();
			numbat_wasm::io::serialize_contract_call_arg(
				caller,
				&mut ___closure_arg_buffer___,
				___api___.clone(),
			);
			numbat_wasm::types::CallbackCall::from_arg_buffer(
				&b"my_callback"[..],
				&___closure_arg_buffer___,
			)
		}
	}
	impl<SA> self::CallbackProxy for CallbackProxyObj<SA> where SA: numbat_wasm::api::SendApi + 'static {}
}

#[test]
fn test_add() {
	use numbat_wasm::api::ContractBase;
	use numbat_wasm_debug::api::RustBigInt;
